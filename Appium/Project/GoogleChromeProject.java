...
//        wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.xpath("//android.view.View[@text='Welcome Back, admin']")));
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(
                AppiumBy.id("action-confirmation")));
        String welcomeMessage = driver.findElement(AppiumBy.id("action-confirmation")).getText();
        ...
        String inCorrectMessage = driver.findElement(AppiumBy.id("action-confirmation")).getText();
