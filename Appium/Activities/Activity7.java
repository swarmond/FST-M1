...
public class Activity7 {
	...
	// Driver Declaration
		...
		public void uiScrollableTest() {
			...
			List<WebElement> imageElements = driver.findElements(AppiumBy.className("android.widget.LinearLayout"));
			...
			String imageText = driver.findElement(AppiumBy
					.androidUIAutomator(UiScrollable + ".scrollForward(55).getChildByText(className(\"android.widget.LinearLayout\"), \"Helen\")"))
					.getText();
					System.out.println("Found " + imageText + "!");
			System.out.println("Found " + imageText + "!");

			// Get image elements after scroll
			imageElements = driver.findElements(AppiumBy.className("android.widget.LinearLayout"));
